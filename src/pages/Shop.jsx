...
import { TextField, Button, Card, CardContent, Typography, Grid, Pagination ,select, MenuItem, FormControl, InputLabel } from '@mui/material';
...
// const handleDirectBuy = async (productId, quantity) => {
//   await handleAddToCart({
//     productId: productId,
//     userId: id,
//     quantity: quantity,
...
//   const [pageNumber, setPageNumber] = useState(1);
//   const [maxPage, setMaxPage] = useState(1);
//   const [quantity, setQuantity] = useState({});  // For managing quantity for each product
//   const navigate = useNavigate();
...
//                     <InputLabel id={`select-label-${product.productId}`}>Quantity</InputLabel>
//                     <Select
//                       labelId={`select-label-${product.productId}`}
...
//                     color="primary"
//                     fullWidth
//                     onClick={() => { handleDirectBuy(product.productId, quantity[product.productId] || 1) }}
//                   >
//                     Buy Now
//                   </Button>
//                 </CardContent>
